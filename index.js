...
const gr = goodreads_api_node_1.default(myCredentials);
...
app.get('/user-data', (req, res) => {
    return goodreadsUtils_1.getUserData(gr).then(data => {
...
app.get('/to-read', async (req, res) => {
    try {
        ...
        let bookArr = await goodreadsUtils_1.getToReadBooks(gr, userId);
